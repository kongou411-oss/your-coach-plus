...
// Score Colors (for 10-axis chart)
val ScoreCalories = Color(0xFF4A9EFF)
val ScoreProtein = Color(0xFFFF9600)
val ScoreCarbs = Color(0xFF58CC02)
val ScoreFat = Color(0xFFFFC800)
val ScoreOver = Color(0xFFEF4444)
val ScoreFiber = Color(0xFF58CC02)
val ScoreDIAAS = Color(0xFF00BCD4)
val ScoreFattyAcid = Color(0xFF8BC34A)
val ScoreGL = Color(0xFFE91E63)
val ScoreVitamin = Color(0xFFFFEB3B)
val ScoreMineral = Color(0xFF607D8B)
val ScoreExercise = Color(0xFFFF86D0)
val ScoreSleep = Color(0xFF9B59B6)
val ScoreCondition = Color(0xFF3F51B5)
val ScoreWater = Color(0xFF1CB0F6)

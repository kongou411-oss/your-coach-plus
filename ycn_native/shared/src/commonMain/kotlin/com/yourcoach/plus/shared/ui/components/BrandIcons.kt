...
/**
 * ブランドアイコン（Google / Apple ログインボタン用）
 */
object BrandIcons {

    /**
     * Google "G" マルチカラーロゴ (24x24)
     */
        ...
        ImageVector.Builder(
            ...
            addPath(
                pathData = PathParser().parsePathString(
                    "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 0 1-2.2 3.32l3.57 2.77c2.08-1.92 3.27-4.74 3.27-8.1z"
                ).toNodes(),

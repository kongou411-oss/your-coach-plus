...
class FirestoreUserRepository : UserRepository {
        ...
        return try {
            val profileData = mapOf(
                "profile" to mapOf(
                    ...
                    "trainingCalorieBonuses" to profile.trainingCalorieBonuses,
    ...
    private fun parseUserProfile(profileMap: Map<String, Any?>): UserProfile {
        ...
        return UserProfile(
            ...
            trainingCalorieBonuses = (profileMap["trainingCalorieBonuses"] as? Map<*, *>)?.mapNotNull { (k, v) -> if (k is String && v is Number) k to v.toInt() else null }?.toMap(),

                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white p-4 rounded-lg border-2 border-gray-200 space-y-3">
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-blue-800">プロフィール設定</p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-blue-800">毎日の記録</p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-blue-800">達成状況を確認</p>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-blue-800">調整・最適化</p>
